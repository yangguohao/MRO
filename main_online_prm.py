...
from external.edge_local.utils import set_seed, load_jsonl, save_jsonl, construct_prompt
...
def prepare_data(data_name, args):
    ...
    out_file = f"{output_dir}/{data_name}/{out_file_prefix}_s{args.start}_e{args.end}_delta{args.prm_threshold}_maxsteps{args.max_steps}_patience{args.patience}.jsonl"
...
def get_responses(args, draft_client, target_client, prm_client, draft_tokenizer, target_tokenizer, prm_tokenizer, prompts, problems):
    ...
    while current_prompts:
        ...
        total_prm_time += time.time()-start
