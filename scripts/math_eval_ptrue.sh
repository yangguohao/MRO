...
OUTPUT_DIR="outputs/draft_Qwen2.5-Math-1.5B-Instruct_target_Qwen2.5-Math-72B-Instruct/math_eval"

SPLIT="test"
NUM_TEST_SAMPLE=10
for PRM_THRESHOLD in 0.85; do

DATA_NAME="mmlu_stem"
TOKENIZERS_PARALLELISM=false \
python3 -u main_online_ptrue.py \
    --data_name ${DATA_NAME} \
